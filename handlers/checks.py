...
async def get_free_checks(message: types.Message, state: FSMContext):
    ...
    names = {"mts": "Салон связи", "sokolov": "Ювелирный магазин - проверки ТОЛЬКО с 4-го января", "gate31": "Магазин одежды - проверки ТОЛЬКО с 4-го января", "irbis": "АЗС",
            "kastorama": "Гипермаркет товаров для дома и строительства", "muztorg": "Магазин музыкальных инструментов - проверки ТОЛЬКО с 4-го января",
             "subway": "Ресторан быстрого обслуживания", "ildebote": "Проверки магазинов косметики", "petshop": "Магазины зоотоваров", "rivgosh": "Магазины косметики - проверки ТОЛЬКО с 4-го января",
             "torti": "Кондитерский магазин - проверки ТОЛЬКО с 9-го января", "domix": "Магазин напольных покрытий - проверки ТОЛЬКО со 2-го января", "informat": "Магазин канц. товаров - проверки ТОЛЬКО с 4-го января", "lexmer": "Магазин мужской одежды - проверки ТОЛЬКО с 4-го января", "respect": "Магазин обуви",
